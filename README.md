...
В проекте используется PostgreSQL 14. Для удобства тестирования, предоставлен docker-compose.yml файл. Настроить учетные данные для подключения можно в файле db.properties или через переменные окружения в /etc/environments.
